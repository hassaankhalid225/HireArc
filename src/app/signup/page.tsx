      ...
      <div className="w-full max-w-[480px] bg-[var(--bg-card)] rounded-[var(--radius-xl)] shadow-[var(--shadow-card)] overflow-hidden">
        ...
        <div className="p-8 pt-6">
          <form className="space-y-5" action="#">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label htmlFor="firstName" className="block text-sm font-semibold text-[var(--text-primary)]">First Name</label>
                <input 
                  type="text" 
                  id="firstName" 
                  placeholder="John" 
              ...
              <div className="space-y-1.5">
                <label htmlFor="lastName" className="block text-sm font-semibold text-[var(--text-primary)]">Last Name</label>
                <input 
                  type="text" 
                  id="lastName" 
                  placeholder="Doe" 
          ...
          <div className="mt-8 relative flex items-center justify-center">
            ...
            <span className="relative bg-[var(--bg-card)] px-4 text-sm text-[var(--text-muted)] font-mono">OR SIGN UP WITH</span>
          </div>
        ...
        <div className="p-6 bg-[var(--bg-base)] text-center border-t border-[var(--border)]">
          <p className="text-sm text-[var(--text-secondary)]">
            Already have an account? <Link href="/login" className="font-semibold text-[var(--primary)] hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
